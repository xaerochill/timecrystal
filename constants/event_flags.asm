...
; Kanto story events
	...
	const_skip ; previously EVENT_RETURNED_MACHINE_PART
	const EVENT_FOUND_POWER_PLANT_ROCKET ; previously EVENT_MET_MANAGER_AT_POWER_PLANT
	const_skip ; previously EVENT_MET_ROCKET_GRUNT_AT_CERULEAN_GYM
	const EVENT_MET_REDS_MOM
	const EVENT_RESTORED_POWER_TO_KANTO
	const EVENT_GOT_COINS_FROM_GAMBLER_AT_CELADON
	const_skip ; previously const EVENT_MET_COPYCAT_FOUND_OUT_ABOUT_LOST_ITEM
	const_skip ; previously const EVENT_RETURNED_LOST_ITEM_TO_COPYCAT
	const_skip ; previously EVENT_GOT_PASS_FROM_COPYCAT
	const_skip ; previously EVENT_GOT_LOST_ITEM_FROM_FAN_CLUB
	...
	const EVENT_FOUGHT_GYARADOS ; previously EVENT_CINNABAR_ROCKS_CLEARED
...
; Kanto hidden items
	...
	const EVENT_GOT_TM_MIMIC ; previously EVENT_FOUND_MACHINE_PART_IN_CERULEAN_GYM
...
; Restored Kanto events
	const EVENT_POWER_PLANT_B3F_VOLTORB1
	const EVENT_POWER_PLANT_B3F_VOLTORB2
	const EVENT_POWER_PLANT_B3F_VOLTORB3
	const EVENT_POWER_PLANT_B3F_VOLTORB4
	const EVENT_POWER_PLANT_B3F_VOLTORB5
	const EVENT_POWER_PLANT_B3F_VOLTORB6
	const EVENT_POWER_PLANT_B3F_ELECTRODE1
	const EVENT_POWER_PLANT_B3F_ELECTRODE2
	const EVENT_POWER_PLANT_B3F_TM_THUNDER
	const EVENT_POWER_PLANT_B3F_TM_REFLECT
	const EVENT_POWER_PLANT_B3F_CARBOS
	const EVENT_POWER_PLANT_B3F_HP_UP
	const EVENT_POWER_PLANT_B3F_RARE_CANDY
	const EVENT_POWER_PLANT_B3F_HIDDEN_PP_UP
	const EVENT_POWER_PLANT_B3F_HIDDEN_MAX_ELIXER
	const EVENT_MOUNT_MOON_ROCKETS
	const EVENT_MOUNT_MOON_B2F_HP_UP
	const EVENT_MOUNT_MOON_B2F_TM_MEGA_PUNCH
; Added Johto Events
...
; ExecutiveM
	...
	const EVENT_BEAT_RADIO_TOWER_PETREL
...
; Johto itemballs
	...
	const_skip ; previously EVENT_GOT_HM07_WATERFALL
...
; Kanto people
	...
	const_skip ; previously ROUTE_5_6_POKEFAN_M_BLOCKS_UNDERGROUND_PATH
	const EVENT_SAFFRON_TRAIN_STATION_POPULATION
	const_skip ; EVENT_COPYCATS_HOUSE_2F_DOLL
...
; New to Crystal
	...
	const_skip ; const EVENT_BATTLE_TOWER_OPEN_CIVILIANS
