...
DEF COLL_BOTTOM_RIGHT_WALL EQU $b8
DEF COLL_BOTTOM_LEFT_WALL  EQU $b9
DEF COLL_TOP_RIGHT_WALL    EQU $ba
DEF COLL_TOP_LEFT_WALL     EQU $bb
DEF COLL_STAIRS_RIGHT_DOWN EQU $bc
DEF COLL_STAIRS_LEFT_DOWN  EQU $bd
DEF COLL_STAIRS_RIGHT_UP   EQU $be
DEF COLL_STAIRS_LEFT_UP    EQU $bf
