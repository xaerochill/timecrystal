	...
	tilecoll LEFT_WALL, FLOOR, LEFT_WALL, WARP_CARPET_DOWN ; 8d
	tilecoll FLOOR, RIGHT_WALL, WARP_CARPET_DOWN, RIGHT_WALL ; 8e
	tilecoll UP_WALL, FLOOR, FLOOR, FLOOR ; 8f
	tilecoll FLOOR, UP_WALL, FLOOR, FLOOR ; 90
	...
	tilecoll WALL, WALL, WATER, WATER ; 9e
	tilecoll WALL, WALL, FLOOR, FLOOR ; 9f
	tilecoll WALL, WALL, WATER, WATER ; a0
	tilecoll FLOOR, FLOOR, WALL, WALL ; a1
	tilecoll WALL, STAIRS_DOWN_LEFT, WALL, FLOOR ; a2
	tilecoll FLOOR, FLOOR, FLOOR, FLOOR ; a3
	tilecoll FLOOR, FLOOR, WALL, WARP_CARPET_DOWN ; a4
	tilecoll FLOOR, FLOOR, WARP_CARPET_DOWN, WALL ; a5
	...
	tilecoll WARP_CARPET_LEFT, FLOOR, WARP_CARPET_LEFT, FLOOR ; b2
	tilecoll FLOOR, WARP_CARPET_RIGHT, FLOOR, WARP_CARPET_RIGHT ; b3
	tilecoll WALL, FLOOR, FLOOR, FLOOR ; b4
	tilecoll WALL, WALL, FLOOR, FLOOR ; b5
	tilecoll HOP_DOWN, HOP_DOWN, WALL, WALL ; b6
	tilecoll HOP_DOWN_RIGHT, WALL, WALL, WALL ; b7
	tilecoll WALL, WALL, FLOOR, FLOOR ; b8
	tilecoll WALL, FLOOR, FLOOR, FLOOR ; b9
	tilecoll FLOOR, FLOOR, FLOOR, STAIRS_UP_RIGHT ; ba
	tilecoll FLOOR, FLOOR, WALL, WALL ; bb
	tilecoll FLOOR, FLOOR, FLOOR, FLOOR ; bc
	tilecoll HOP_DOWN, HOP_DOWN, WALL, WALL ; bd
	tilecoll HOP_DOWN, FLOOR, WALL, FLOOR ; be
	...
	tilecoll HOP_DOWN, WALL, WALL, WALL ; d4
	tilecoll FLOOR, WALL, FLOOR, WALL ; d5
	tilecoll WALL, HOP_DOWN_LEFT, WALL, WALL ; d6
	tilecoll WALL, HOP_LEFT, WALL, HOP_LEFT ; d7
	tilecoll FLOOR, FLOOR, FLOOR, FLOOR ; d8
	tilecoll LONG_GRASS, LONG_GRASS, LONG_GRASS, LONG_GRASS ; d9
