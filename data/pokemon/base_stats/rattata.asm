	...
	; tm/hm learnset
	tmhm HEADBUTT, CURSE, TOXIC, ROCK_SMASH, HIDDEN_POWER, SUNNY_DAY, SNORE, BLIZZARD, ICY_WIND, PROTECT, ENDURE, FRUSTRATION, IRON_TAIL, THUNDER, RETURN, DIG, SHADOW_BALL, MUD_SLAP, DOUBLE_TEAM, SWAGGER, SLEEP_TALK, SWIFT, DEFENSE_CURL, REST, ATTRACT, THIEF, COUNTER, THUNDERBOLT, BIDE, BODY_SLAM, BUBBLEBEAM, DOUBLE_EDGE, MIMIC, RAGE, SKULL_BASH, SUBSTITUTE, TAKE_DOWN, WATER_GUN
	; end
