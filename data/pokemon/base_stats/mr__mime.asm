	...
	; tm/hm learnset
	tmhm DYNAMICPUNCH, HEADBUTT, CURSE, TOXIC, ZAP_CANNON, PSYCH_UP, HIDDEN_POWER, SUNNY_DAY, SNORE, HYPER_BEAM, PROTECT, ENDURE, FRUSTRATION, SOLARBEAM, THUNDER, RETURN, PSYCHIC_M, SHADOW_BALL, MUD_SLAP, DOUBLE_TEAM, ICE_PUNCH, SWAGGER, SLEEP_TALK, THUNDERPUNCH, DREAM_EATER, REST, ATTRACT, THIEF, FIRE_PUNCH, NIGHTMARE, FLASH, THUNDERBOLT, SUBSTITUTE, LIGHT_SCREEN, REFLECT, MIMIC, BIDE, BODY_SLAM, COUNTER, DOUBLE_EDGE, MEGA_KICK, MEGA_PUNCH, METRONOME, PSYWAVE, RAGE, SEISMIC_TOSS, SKULL_BASH, SUBMISSION, TAKE_DOWN, TELEPORT, THUNDER_WAVE
	; end
