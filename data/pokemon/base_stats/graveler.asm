	...
	; tm/hm learnset
	tmhm DYNAMICPUNCH, HEADBUTT, CURSE, ROLLOUT, TOXIC, ROCK_SMASH, HIDDEN_POWER, SUNNY_DAY, SNORE, PROTECT, ENDURE, FRUSTRATION, EARTHQUAKE, RETURN, DIG, MUD_SLAP, DOUBLE_TEAM, SWAGGER, SLEEP_TALK, SANDSTORM, FIRE_BLAST, DEFENSE_CURL, REST, ATTRACT, FIRE_PUNCH, STRENGTH, FLAMETHROWER, SELFDESTRUCT, EXPLOSION, MEGA_PUNCH, ROCK_SLIDE, BIDE, BODY_SLAM, COUNTER, DOUBLE_EDGE, FISSURE, METRONOME, MIMIC, RAGE, SEISMIC_TOSS, SUBMISSION, SUBSTITUTE, TAKE_DOWN
	; end
