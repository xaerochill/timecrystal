	...
	; tm/hm learnset
	tmhm DYNAMICPUNCH, HEADBUTT, CURSE, ROLLOUT, ROAR, TOXIC, ROCK_SMASH, HIDDEN_POWER, SUNNY_DAY, SNORE, HYPER_BEAM, PROTECT, ENDURE, FRUSTRATION, EARTHQUAKE, RETURN, DIG, MUD_SLAP, DOUBLE_TEAM, SWAGGER, SLEEP_TALK, SANDSTORM, FIRE_BLAST, DEFENSE_CURL, REST, ATTRACT, FIRE_PUNCH, FURY_CUTTER, STRENGTH, FLAMETHROWER, SELFDESTRUCT, EXPLOSION, MEGA_PUNCH, ROCK_SLIDE, BIDE, BODY_SLAM, COUNTER, DOUBLE_EDGE, FISSURE, MEGA_KICK, METRONOME, MIMIC, RAGE, SEISMIC_TOSS, SUBMISSION, SUBSTITUTE, TAKE_DOWN
	; end
