	...
	; tm/hm learnset
	tmhm CURSE, ROLLOUT, TOXIC, PSYCH_UP, HIDDEN_POWER, SUNNY_DAY, SNORE, PROTECT, GIGA_DRAIN, ENDURE, FRUSTRATION, SOLARBEAM, RETURN, PSYCHIC_M, DOUBLE_TEAM, SWAGGER, SLEEP_TALK, SLUDGE_BOMB, DREAM_EATER, REST, ATTRACT, THIEF, NIGHTMARE, STRENGTH, FLASH, MEGA_DRAIN, REFLECT, SWEET_SCENT, BIDE, DOUBLE_EDGE, EGG_BOMB, EXPLOSION, MIMIC, PSYWAVE, RAGE, SELFDESTRUCT, SUBSTITUTE, TAKE_DOWN, TELEPORT
	; end
