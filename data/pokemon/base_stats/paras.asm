	...
	; tm/hm learnset
	tmhm CURSE, TOXIC, ROCK_SMASH, HIDDEN_POWER, SUNNY_DAY, SWEET_SCENT, SNORE, PROTECT, GIGA_DRAIN, ENDURE, FRUSTRATION, SOLARBEAM, RETURN, DIG, DOUBLE_TEAM, SWAGGER, SLEEP_TALK, SLUDGE_BOMB, REST, ATTRACT, THIEF, FURY_CUTTER, CUT, FLASH, COUNTER, LIGHT_SCREEN, SWEET_SCENT, BIDE, BODY_SLAM, DOUBLE_EDGE, MEGA_DRAIN, MIMIC, RAGE, REFLECT, SKULL_BASH, SUBSTITUTE, SWORDS_DANCE, TAKE_DOWN
	; end
