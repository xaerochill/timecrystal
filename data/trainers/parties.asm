...
PetrelGroup:
	...
	db 30, GOLBAT,     NO_ITEM, BITE, CONFUSE_RAY, WING_ATTACK, TOXIC
	db 30, RATICATE,   NO_ITEM, QUICK_ATTACK, HYPER_FANG, PURSUIT, HEADBUTT
	db 30, KOFFING,    NO_ITEM, TACKLE, SELFDESTRUCT, SLUDGE, SMOKESCREEN
	db 30, KOFFING,    NO_ITEM, TACKLE, SELFDESTRUCT, SLUDGE, SMOKESCREEN
	db 30, KOFFING,    NO_ITEM, TACKLE, SELFDESTRUCT, SLUDGE, SMOKESCREEN
	db 32, WEEZING,    NO_ITEM, TACKLE, EXPLOSION, SLUDGE, SMOKESCREEN
	db -1 ; end
