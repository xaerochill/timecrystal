...
Route32Callback:
	...
	iftrue .UnownUnlocked
	changeblock  3,  6, $05 ; trees
	changeblock  3,  7, $05 ; trees
	changeblock  4,  7, $05 ; trees
	changeblock  2,  8, $05 ; trees
	changeblock  3,  8, $05 ; trees
	changeblock  4,  8, $05 ; trees
	changeblock  0,  9, $05 ; trees
	changeblock  1,  9, $05 ; trees
	changeblock  2,  9, $05 ; trees
	changeblock  3,  9, $05 ; trees
	changeblock  4,  9, $05 ; trees
	changeblock  1, 10, $05 ; trees
	changeblock  2, 10, $05 ; trees
	changeblock  1, 11, $05 ; trees
.UnownUnlocked:
	endcallback
...
Route32_MapEvents:
	...
	warp_event  4,  3, ROUTE_32_RUINS_OF_ALPH_GATE, 3
	warp_event  6, 79, UNION_CAVE_1F, 4
	warp_event  2, 15, VIOLET_CITY, 10

	def_coord_events
	coord_event 17, 19, SCENE_ROUTE32_COOLTRAINER_M_BLOCKS, Route32CooltrainerMStopsYouScene
	...
	bg_event  9, 23, BGEVENT_ITEM, Route32HiddenGreatBall
	...
	object_event 12, 22, SPRITE_YOUNGSTER, SPRITEMOVEDATA_SPINRANDOM_FAST,  0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 3, TrainerYoungsterAlbert, -1
	...
	object_event 13, 34, SPRITE_LASS, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_TRAINER, 1, TrainerPicnickerLiz1, -1
	object_event 16, 19, SPRITE_COOLTRAINER_M, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route32CooltrainerMScript, -1
	object_event 11, 82, SPRITE_YOUNGSTER, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 3, TrainerBirdKeeperPeter, -1
