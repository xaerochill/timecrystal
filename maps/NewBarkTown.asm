...
NewBarkTown_MapEvents:
	...
	def_bg_events
	bg_event  7,  7, BGEVENT_READ, NewBarkTownSign
	...
	object_event 15, 10, SPRITE_FISHER, SPRITEMOVEDATA_WALK_UP_DOWN, 0, 1, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, NewBarkTownFisherScript, -1
