...
GoldenrodCity_MapEvents:
	...
	warp_event 29, 26, GOLDENROD_BIKE_SHOP, 1
	warp_event 15,  7, GOLDENROD_HAPPINESS_RATER, 1
	warp_event  3, 27, BILLS_FAMILYS_HOUSE, 1
	...
	warp_event 11,  5, GOLDENROD_NAME_RATER, 1
	...
	bg_event 32, 26, BGEVENT_READ, GoldenrodCityBikeShopSign
	...
	object_event 35, 22, SPRITE_COOLTRAINER_F, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityCooltrainerF2Script, EVENT_GOLDENROD_CITY_CIVILIANS
	...
	object_event  5, 29, SPRITE_GRAMPS, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 1, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityGrampsScript, EVENT_GOLDENROD_CITY_CIVILIANS
	...
	object_event  6, 22, SPRITE_POKEFAN_M, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, MoveTutorScript, -1
